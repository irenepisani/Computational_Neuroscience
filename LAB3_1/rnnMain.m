...
%% Main script for Recurrent Neural Network (RNN) 
...
[bestParams, errVL, errTR] = rnnRandomSearch(trX, trY, vlX, vlY, numTrials);
...
[predDEV, errDEV, predTS, errTS, structure, records] = rnn(bestParams,devX, devY, tsX, tsY);
view(structure)
...
save(fullfile('Results', 'RNN-optimal-hyperparam.mat'), 'bestParams')

% save training, validation, development (tr + vl) and test Mean Squared Error
save(fullfile('Results', 'RNN-mse.mat'), 'performance')

% Generate and save plots 
narma10Plot("RNN", records, predDEV, devY, predTS, tsY)
