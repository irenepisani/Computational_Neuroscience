...
%% Function to generate a random configuration of TDNN's hyper-paramter values
...
function [hyperParams] = tdnnRandomConfig()

trFunc = ["traingd", "traingdm", "traingdx", "trainrp", "trainlm"];
hyperParams = struct();

hyperParams.lr = rand;
hyperParams.reg = 0.1 *rand;
hyperParams.momentum = rand;
hyperParams.epochs = 1000;
hyperParams.inputDelay = randi(25);
hyperParams.hiddenSize = randi(25, [1, randi(10)]);
